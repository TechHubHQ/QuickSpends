...
export const SpendingVelocityCard: React.FC<SpendingVelocityCardProps> = ({
      ...
      <View style={styles.container}>
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>
            {loading ? "Calculating..." : "Not enough data"}
          </Text>
        </View>
      </View>
    );
  ...
  const progressPercent = Math.min(
    (data.currentSpend / data.averageSpend) * 100,
    150,
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View
        ...
        style={[styles.mainContent, isNarrow && { paddingHorizontal: 0 }]}
      >
        {/* Velocity Gauge */}
        ...
        <View style={styles.messageContainer}>
          ...
          />
          <Text
            style={[styles.messageText, isNarrow && { fontSize: 12 }]}
            numberOfLines={2}
            ellipsizeMode="tail"
          >
          ...
          <View style={styles.legendItems}>
            <View style={styles.legendItem}>
              ...
              <Text style={styles.legendText}>
                Under 80%: On track or under budget
              </Text>
            </View>
            <View style={styles.legendItem}>
              <View
              ...
              />
              <Text style={styles.legendText}>
                80-100%: Approaching your average
              </Text>
            </View>
            <View style={styles.legendItem}>
              <View
              ...
              />
              <Text style={styles.legendText}>
                Over 100%: Spending faster than usual
              </Text>
            </View>
          </View>
